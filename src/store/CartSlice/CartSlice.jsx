...
export const getCartData = createAsyncThunk("cart/getCartData", async () => {
    ...
    return fetch('https://ngglobalwebapi20231210182820.azurewebsites.net/api/cart/getmycartproducts',{
        headers: { 
...
const addToCart = createAsyncThunk("cart/addToCart", async (itemId) => {
    const userToken = JSON.parse(localStorage.getItem('userToken'))
    return fetch('https://ngglobalwebapi20231210182820.azurewebsites.net/api/cart/addincart', {
        method: 'POST',
        headers: { 
